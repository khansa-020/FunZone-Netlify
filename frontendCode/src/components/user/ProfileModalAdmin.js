...
import { deleteUser, updateUserByAdmin } from "../../actions/UserAction";
import {
  getStorage,
  ref,
...
const ProfileModalAdmin = ({ modalOpened, setModalOpened, data }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await dispatch(updateUserByAdmin(data._id, UserData));
      ...
      >
        ...
        <form className="infoForm">
          ...
          <div>
            ...
            Cover Image
            <input type="file" name="coverPicture" onChange={ImageChange} />
          </div>
